<?php if (!empty($pagination)): ?>
    ...
    @if ($showmore && isset($pagination['arrow_right']))
        ...
        <div class="show-more-wrapper" onclick="make_pagination(this, true); return false;">
            ...
            <x-inputs.button 
                ...
                :href="$pagination['link'].$pagination['separator'].'='.$pagination['arrow_right']" 
            >
                {{ $fields['showmore'] }}
            </x-inputs.button>
        </div>
    ...
    <div class="pagination-wrapper mb-100">
        <div class="container">
            <div class="pagination" data-param="{{ $pageparam }}">
                
                <?php if (isset($pagination['arrow_first'])): ?>
                    <div class="pagination-btn-wrapper" onclick="make_pagination(this, false, '{{ $pageparam }}'); return false;">
                        <a 
                            href="<?php echo ($pagination['link']) ?>" 
                            class="text-main-regular pagination-btn"
                        >
                ...
                <?php if (isset($pagination['arrow_left'])): ?>
                    <div class="pagination-btn-wrapper" onclick="make_pagination(this, false, '{{ $pageparam }}'); return false;">
                        <a 
                            href="<?php echo ($pagination['link']) ?><?php echo ($pagination['arrow_left'] != 1) ? $pagination['separator'].'='.$pagination['arrow_left'] : '' ?>" 
                            class="text-main-regular pagination-btn"
                        >
                ...
                <div class="pagination-btn-wrapper" onclick="make_pagination(this, false, '{{ $pageparam }}'); return false;">
                    <a 
                        href="<?php echo ($pagination['link']) ?>" 
                        class="text-main-regular pagination-btn<?php if ($pagination['active'] == 1) echo ' active' ?>"
                    >
                        1
                    </a>
                </div>
                ...
                <?php if (isset($pagination['middle'])): ?>
                    <?php foreach ($pagination['middle'] as $item): ?>
                        ...
                        <div class="pagination-btn-wrapper" onclick="make_pagination(this, false, '{{ $pageparam }}'); return false;">
                            <a 
                                href="<?php echo ($pagination['link']) ?><?php echo $pagination['separator'] ?>=<?php echo $item ?>" 
                                class="text-main-regular pagination-btn<?php if ($pagination['active'] == $item) echo ' active' ?>"
                            >
                                <?php echo $item ?>
                            </a>
                        </div>
                ...
                <div class="pagination-btn-wrapper" onclick="make_pagination(this, false, '{{ $pageparam }}'); return false;">
                    <a  
                        href="<?php echo ($pagination['link']) ?><?php echo $pagination['separator'] ?>=<?php echo $pagination['last'] ?>" 
                        class="text-main-regular pagination-btn<?php if ($pagination['active'] == $pagination['last']) echo ' active' ?>"
                    >
                ...
                <?php if (isset($pagination['arrow_right'])): ?>
                    <div class="pagination-btn-wrapper" onclick="make_pagination(this, false, '{{ $pageparam }}'); return false;">
                        <a 
                            href="<?php echo ($pagination['link']) ?><?php echo $pagination['separator'] ?>=<?php echo $pagination['arrow_right'] ?>" 
                            class="text-main-regular pagination-btn"
                        >
                ...
                <?php if (isset($pagination['arrow_last'])): ?>
                    <div class="pagination-btn-wrapper" onclick="make_pagination(this, false, '{{ $pageparam }}'); return false;">
                        <a 
                            href="<?php echo ($pagination['link']) ?><?php echo $pagination['separator'] ?>=<?php echo $pagination['arrow_last'] ?>" 
                            class="text-main-regular pagination-btn"
                        >
...
<script>
    ...
    async function make_pagination(elm, showmore = false, pageparam){

        let href = $(elm).child().attr('href')

        const response = await post(href, {
            pageparam: elm.closest('.pagination').getAttribute('data-param')
        }, true, true)
        ...
        if (response.success){
            ...
            if (showmore){
                ...
                if (pageparam == 'page-modal') {
                    $('.modal-application-tours-content').html(response.data.html)
                } else {
            ...
            if (pageparam == 'page-modal') {
                $('.modal-application-tours-pagination').html(response.data.pagination)
            } else {
