<div class="modal modal-success fade-in" id="modal-success">
    <div class="container-modal container-modal-success">
        ...
        <div class="h3 success-title">{{$fields['title']}}</div>
...
<style>
    ...
    .modal-success .input-wrapper {
        margin-bottom: 20px;
    }

    .modal-success .input-wrapper .input-label {
