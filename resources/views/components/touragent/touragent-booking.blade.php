<div class="touragent-booking">
    ...
    @else
        ...
        <div class="touragent-booking-searhform">
            ...
            <x-inputs.button class="yellow touragent-booking" onclick="sort_booking_by_departure(this, '{{ route('sort-booking-by-departure', [], true) }}'); return false;">
                Сортировать по дате вылета
            </x-inputs.button>
        </div>

        <div class="touragent-booking-tours-wrapper" id="touragent-booking-tours-wrapper">
            <x-touragent.booking-tours :booking="$booking"/>
        </div>
